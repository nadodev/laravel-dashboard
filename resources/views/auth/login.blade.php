                        ...
                        <div class="tabs-box">
                            <div class="tab-btn-box">
                                <ul class="tab-btns tab-buttons centred clearfix">
                                    ...
                                    <li class="tab-btn" data-tab="#tab-2">Registrar</li>
                                </ul>
                            </div>
    <div class="tabs-content">
        <div class="tab active-tab" id="tab-1">
            <div class="inner-box">
                ...
                <form action="{{ route('login.store') }}" method="post" class="default-form">
               @csrf
                    ...
                    <div class="form-group message-btn">
                        <button type="submit" class="theme-btn btn-one">Entrar</button>
                    </div>
                </form>
                <div class="othre-text">
                    <p>Não tem uma conta? <a href="signup.html">Registre agora</a></p>
                </div>
            </div>
        </div>
